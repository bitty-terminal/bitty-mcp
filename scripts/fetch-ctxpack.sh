...
#      bitty-terminal/bitty-mcp-workflow, override with --url / --mirror),
...
#                  (default: $WORKFLOW_MIRROR_DIR or <repo>/../bitty-mcp-workflow).
...
MIRROR_DEFAULT="$REPO_ROOT/../bitty-mcp-workflow"
MIRROR_URL_DEFAULT="https://github.com/bitty-terminal/bitty-mcp-workflow.git"
