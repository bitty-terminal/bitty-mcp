...
3. Start only dependency-ready work. Record decisions, blockers, risks,
   validation, and remaining gaps while work is active.
...
6. A pull request states Issue/task links, user and protocol outcome, security
   and compatibility impact, affected docs, validation evidence, dependencies,
   and cross-repository ordering.
7. Review is independent from implementation. Reviewers inspect the diff,
   accepted contracts, abuse and failure cases, synchronized docs, and
   reproducible CI evidence.
8. Documentation synchronization is part of definition of done. Public
   behavior, schemas, capabilities, compatibility, security, or release changes
